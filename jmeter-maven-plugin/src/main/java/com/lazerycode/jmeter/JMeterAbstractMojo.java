...
public abstract class JMeterAbstractMojo extends AbstractMojo {
	...
	/**
	 *  Path under which JMeter outputs files are stored.
	 *
	 * @parameter expression="${jmeter.resultfiles.basedir}" 
	 * default-value="${basedir}/results/jmeter"
	 * 
	 */
	...
	protected void generateJMeterDirectoryTree() {
		...
		binDir.mkdirs();
		resultsDir = new File(resultFilesDirectory,"");
		resultsDir.mkdirs();
